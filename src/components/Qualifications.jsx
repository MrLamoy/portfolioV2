...
export default function Qualifications() {
  ...
  const educationData = [
    ...
    },
    {
      ...
      institution: "Bantayan Senior High School",
      year: "2018 - 2019",
    ...
    },
    {
      ...
      institution: "Bantayan National High School",
      year: "2016 - 2017",
  ...
  const experienceData = [
    {
      id: 1,
      title: "2 Years Web Development Experience",
      institution: "School System Management",
      year: "2024 - Present",
      description: "Developed and maintained a comprehensive School System Management platform, including student enrollment, class scheduling, grade management, and reporting modules. Implemented responsive web interfaces using modern front-end technologies and integrated secure back-end functionality to streamline administrative processes and enhance user experience for students, teachers, and administrators."
    }
  ...
  const certificationData = [
    {
      ...
      institution: "Zuitt",
      year: "2024",
      description: "Demonstrated proficiency in HTML, CSS, JavaScript, and modern front-end frameworks to build responsive and interactive web interfaces, focusing on usability and performance.",
    ...
    },
    {
      ...
      institution: "Zuitt",
      year: "2024",
      description: "Developed server-side applications, APIs, and database integrations using modern back-end technologies, ensuring secure, scalable, and efficient web solutions.",
    ...
    },
    {
      ...
      institution: "Zuitt",
      year: "2024",
      description: "Acquired comprehensive full-stack development skills, combining front-end and back-end expertise to build complete, functional web applications from design to deployment.",
    ...
    },
    {
      ...
      institution: "Zuitt",
      year: "2024",
      description: "Successfully completed the intensive web development program at Zuitt, demonstrating practical skills in building and deploying professional web applications.",
