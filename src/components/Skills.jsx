  ...
  const skillsData = [
    {
      ...
      skills: [
        ...
        { name: "Bootstrap", level: 85, icon: "/icons/logo-bootstrap.png" }
      ]
    },
    {
      category: "Backend",
      ...
      skills: [
        ...
        { name: "JavaScript", level: 85, icon: "/icons/js.jpg" },
        { name: "PHP", level: 75, icon: "/icons/php.png" },
        { name: "Postman", level: 75, icon: "/icons/logo-postman.png" },
        { name: "Json", level: 75, icon: "/icons/logo-rest.png" },
